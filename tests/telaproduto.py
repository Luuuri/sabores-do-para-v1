...
class TelaProdutos:
    ...
    def abrir_tela_caixa(self):
        ...
        print("Abrindo tela Caixa")

    def abrir_tela_online(self):

        print("Abrindo tela On-line")

    def abrir_tela_produtos(self):

        print("Você já está na tela Produtos")

    def abrir_tela_clientes(self):

        print("Abrindo tela Clientes")

    def abrir_tela_estoque(self):

        print("Abrindo tela Estoque")

    def abrir_tela_relatorios(self):

        print("Abrindo tela Relatórios")

    def abrir_tela_funcionarios(self):

        print("Abrindo tela Funcionários")
