# chama no terminal por python -m app.view.produto_view
...
class TelaProdutos:
    def __init__(self, root):
        self.root = root
        self.root.title("Sabores do Pará ")
    ...
    def editar_produto(self, produto):
        ...
        self.categoria_menu.set(produto.categoria)
        self.status_var.set(produto.status)
